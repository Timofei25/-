...
begin
 ...
 if (l1=1) and (l2=3) then begin x:=x/16.387; Edit1.Text:=floattostr(x); end else
 if (l1=1) and (l2=4) then begin x:=x/28316.847; Edit1.Text:=floattostr(x); end else
 if (l1=1) and (l2=5) then begin x:=x/764554.858; Edit1.Text:=floattostr(x); end else
 if (l1=2) and (l2=1) then begin x:=x*1000000; Edit1.Text:=floattostr(x); end else
 if (l1=2) and (l2=3) then begin x:=x*61023.744; Edit1.Text:=floattostr(x); end else
 if (l1=2) and (l2=4) then begin x:=x/0.028; Edit1.Text:=floattostr(x); end else
 if (l1=2) and (l2=5) then begin x:=x/0.765; Edit1.Text:=floattostr(x); end else
 if (l1=3) and (l2=1) then begin x:=x*16.387; Edit1.Text:=floattostr(x); end else
 if (l1=3) and (l2=2) then begin x:=x/61023.744; Edit1.Text:=floattostr(x); end else
 ...
 if (l1=4) and (l2=1) then begin x:=x*28316.847; Edit1.Text:=floattostr(x); end else
 if (l1=4) and (l2=2) then begin x:=x*0.028; Edit1.Text:=floattostr(x); end else
 ...
 if (l1=5) and (l2=1) then begin x:=x*764554.858; Edit1.Text:=floattostr(x); end else
 if (l1=5) and (l2=2) then begin x:=x*0.765; Edit1.Text:=floattostr(x); end else
